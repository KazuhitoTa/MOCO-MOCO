...
public class TileScriptableObject : MonoBehaviour
{
    ...
    [SerializeField]CreateMap createMap;
    ...
    private void GetTilemapObjectPositions()
    {
        ...
        createMap.mapDateList[1].mapObjPos=tilePos.temp;
        createMap.mapDateList[1].mapGenre=tilePos.tmp;
        createMap.mapDateList[1].xMax=xMax;
        createMap.mapDateList[1].xMin=xMin;
        createMap.mapDateList[1].yMax=yMax;
        createMap.mapDateList[1].yMin=yMin;
